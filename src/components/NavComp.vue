<template>
  ...
  <ul class="nav">
    <li @click="closeMenu"><a class="nav__item" href="#about">About us</a></li>
    <li @click="closeMenu"><a class="nav__item" href="#catalog">Catalog</a></li>
